...
(function() {
  ...
  // --- Vendor resolution ---
  var beautify = (typeof css_beautify_mod !== 'undefined')
    ? (css_beautify_mod.css_beautify || css_beautify_mod.default || css_beautify_mod)
    : null;
  ...
  function checkVendor() {
    var cssoOk = (typeof csso !== 'undefined' && typeof csso.minify === 'function');
    var beautifyOk = (typeof beautify === 'function');

    if (!beautifyOk && typeof css_beautify_mod !== 'undefined') {
      beautify = css_beautify_mod.css_beautify || css_beautify_mod.default || css_beautify_mod;
      beautifyOk = (typeof beautify === 'function');
    }

    vendorReady = cssoOk && beautifyOk;
    return vendorReady;
  }
  ...
  function downloadOutput() {
    ...
    var ext = (mode === 'minify') ? '.min.css' : '.css';
  ...
  function setupDragDrop() {
    ...
    codeInput.addEventListener('drop', function(e) {
      ...
      var file = files[0];
      // Accept .css and text files
      var validExts = ['.css', '.txt'];
